...
export default function CheckoutForm() {
    ...
    const cartItems = Object.values(items) as CartItem[]
            ...
            const res = await fetch('/api/orders', {
                ...
                body: JSON.stringify({
                    ...
                    payment: {
                        ...
                        transactionId: paymentMethod === 'online' ? formData.transactionId : '',
    ...
    if (cartItems.length === 0) {
        return (
            <div className="text-center py-12">
                ...
                <h2 className="text-2xl font-display font-medium mb-4 mt-4">
                    Your cart is empty
                </h2>
            ...
            <div>
                ...
                <form id="checkout-form" onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <label className="flex items-start gap-3 p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                                ...
                                <div>
                                    ...
                                    <span className="text-sm text-gray-500">
                                        Pay when you receive your order. No extra fees.
                                    </span>
                                </div>
                            </label>
                            ...
                            <label className="flex items-start gap-3 p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                                ...
                                <div>
                                    <span className="block font-medium">
                                        Online Payment (WiPay / Endcash / Bank Transfer)
                                    </span>
                                    <span className="text-sm text-gray-500">
                        ...
                        {paymentMethod === 'online' && (
                            <div className="mt-6 p-6 bg-gray-50 rounded-lg border border-gray-200">
                                <p className="text-sm text-gray-600 mb-4">
                                    To confirm your order, please make a payment via WiPay/Endcash
                                    or transfer to Republic Bank <strong>#123456</strong>.
                                </p>
                                <a
                                    href="#"
                                    target="_blank"
                    ...
                    <button
                        ...
                        className="w-full mt-8 bg-primary text-background-light py-3 px-6 rounded-lg font-medium hover:opacity-90 transition-opacity disabled:opacity-50"
                    >
