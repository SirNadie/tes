        ...
        <header className="fixed top-0 z-40 w-full bg-background-light/90 backdrop-blur-md border-b border-white/10 shadow-sm transition-all duration-300">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-8 py-4">
                <Link href="/" className="flex items-center gap-3 group relative z-50">
                    ...
                    />
                    <span className="hidden md:block text-xl font-display font-medium tracking-wide group-hover:text-primary transition-colors">
                        The Everyday Shop
                    </span>
                </Link>
                ...
                <nav className="hidden items-center gap-8 md:flex">
                    <Link
                        className="text-sm font-medium leading-normal text-gray-500 hover:text-primary transition-colors relative after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:bg-primary after:transition-all hover:after:w-full"
                        href="/shop"
                    >
                        Shop
                    </Link>
                ...
                <div className="absolute right-0 top-0 h-[100dvh] w-full bg-white shadow-2xl flex flex-col pt-20">
                    <nav className="flex-1 overflow-y-auto py-6 px-8">
                        <ul className="space-y-6">
                            ...
                            >
                                <Link
                                    className="flex items-center justify-between text-2xl font-display font-medium text-gray-900 hover:text-primary transition-colors group"
                                    href="/shop"
                                    onClick={toggleMenu}
                                >
                                    Shop
